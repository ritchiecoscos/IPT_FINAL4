...
<body>
    <div class="container col-md-4 offset-md-4">
        ...
        <div class="card shadow mb-5 rounded border border-dark mt-5">
            <div class="card-body rounded" style="background-color: white;" id="card-bodyy">
                <h2 class="text-center mb-4 " style="color:#b8c8cb; font-size: 25px; color: black">Log In</h2>
