<div>
    <div class="container mt-3">
        <h1 style="font-weight: 400; font-size:25px; color: black">Roles</h1>
        @include('livewire.modals.admin-modal')
        @if (session('message'))
            <div class="alert alert-success text-black text-center" id="messagee">{{ session('message') }}</div>
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #638b33; color:white;" data-toggle="modal" data-target="#modal-roles"> + Create New Role</div>
