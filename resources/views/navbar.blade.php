<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color: green;">
        ...
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            <li class="nav-item">
                <a class="nav-link text-white {{ 'dashboard' == request()->path() ? 'active' : '' }}"
                    href="{{ '/dashboard' }}"></span>Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ 'recent-post' == request()->path() ? 'active' : '' }}"
                    href="{{ '/recent-post' }}"></span>Recent Talks</a>
            </li>
            ...
            @role('admin')
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu bg-white bg-opacity-75" aria-labelledby="dropdownMenuButton" id="select3">

                        <li class="nav-item">
                            <a style="margin-left: 20px"
                                class="nav-link text-black {{ 'log' == request()->path() ? 'active' : '' }}"
                                href="{{ '/log' }}">Logs</a>
                        </li>
                        <span class="nav-line"></span>
                        <li class="nav-item">
                            <a style="margin-left: 20px"
                                class="nav-link text-black {{ 'admin/roles' == request()->path() ? 'active' : '' }}"
                                href="{{ route('admin.roles.index') }}">Roles</a>
                        </li>
                        <span class="nav-line"></span>
                        <li class="nav-item">
                            <a style="margin-left: 20px"
                                class="nav-link text-black {{ 'admin/permissions' == request()->path() ? 'active' : '' }}"
                                href="{{ route('admin.permissions.index') }}">Permissions</a>
                        </li>
                        <li class="nav-item">
                            <a style="margin-left: 20px"
                                class="nav-link text-black {{ 'admin/users' == request()->path() ? 'active' : '' }}"
            ...
            @endrole
            <li class="nav-item">
                <a class="nav-link text-white" href="{{ '/logout' }}"></span>Log out</a>
            </li>
    </div>
</nav>
